...
class ToolManager{
  ...
  init() {
    tools = [
      ...
      Tool(name: "Chobbin",width: 4, height: 4, color: PieceColor.Red.rawValue, type: PieceClass.Chobbin.rawValue),
      Tool(name: "Chobbin",width: 4, height: 4, color: PieceColor.Blue.rawValue, type: PieceClass.Chobbin.rawValue)
